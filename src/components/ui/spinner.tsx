  ...
  return (
    <div aria-label="Loading..." role="status">
      <Loader
        className={cn(
          "animate-spin",
          sizesClasses[size as keyof SizeProps] || sizesClasses.md,
          strokeClasses[color as keyof StrokeProps] || strokeClasses.blue,
        )}
      />
    </div>
  );
    ...
    <div aria-label="Loading..." role="status">
      <svg
        className={cn(
          "animate-spin",
          sizesClasses[size as keyof SizeProps] || sizesClasses.md,
          fillClasses[color as keyof FillProps] || fillClasses.blue,
        )}
        viewBox="3 3 18 18"
      >
        <path
...
export const Dots_v1 = (_props: SpinnerProps) => (
  <div className="w-fit">
...
export const Dots_v2 = (_props: SpinnerProps) => (
...
export const Dots_v3 = (_props: SpinnerProps) => {
  return (
